...
namespace QuanLyThuVien
{
    ...
    {
        string Conn = "Data Source=LAPTOP-P7T5NJ4B;Initial Catalog=QLTV;Integrated Security=True";
        ...
        private void btnInDG_Click(object sender, EventArgs e)
        {
            ...
            {
                worksheet.Cells[rowIndex, column.Index + 1] = column.HeaderText;
            }
            ...
            foreach (DataGridViewRow row in dgvSinhVien.Rows)
            {
                ...
                {
                    worksheet.Cells[rowIndex, cell.ColumnIndex + 1] = cell.Value;
                }
                rowIndex++;
            }
        ...
        private void btnInMT_Click(object sender, EventArgs e)
        {
            Microsoft.Office.Interop.Excel.Application excel = new Microsoft.Office.Interop.Excel.Application();
            excel.Visible = true;
            Microsoft.Office.Interop.Excel.Workbook workbook = excel.Workbooks.Add(System.Reflection.Missing.Value);
            ...
            // Ghi tiêu đề
            int rowIndex = 1;
            foreach (DataGridViewColumn column in dgvMuonSach.Columns)
            {
                worksheet.Cells[rowIndex, column.Index + 1] = column.HeaderText;
            }
        ...
        private void btnInNV_Click(object sender, EventArgs e)
        {
            ...
            // Ghi tiêu đề
            int rowIndex = 1;
            foreach (DataGridViewColumn column in dgvQuanLy.Columns)
            {
                worksheet.Cells[rowIndex, column.Index + 1] = column.HeaderText;
            }
            ...
            // Ghi dữ liệu
            rowIndex++;
            foreach (DataGridViewRow row in dgvQuanLy.Rows)
            {
                foreach (DataGridViewCell cell in row.Cells)
                {
                    worksheet.Cells[rowIndex, cell.ColumnIndex + 1] = cell.Value;
        ...
        private void btnInTK_Click(object sender, EventArgs e)
        {
            ...
            // Ghi tiêu đề
            int rowIndex = 1;
            foreach (DataGridViewColumn column in dgvDSMuon.Columns)
            {
                worksheet.Cells[rowIndex, column.Index + 1] = column.HeaderText;
            }
            ...
            // Ghi dữ liệu
            rowIndex++;
            foreach (DataGridViewRow row in dgvDSMuon.Rows)
            {
                foreach (DataGridViewCell cell in row.Cells)
                {
                    worksheet.Cells[rowIndex, cell.ColumnIndex + 1] = cell.Value;
        ...
        private void guna2CheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                txtMatKhau.UseSystemPasswordChar = false; // Hiển thị ký tự thật
            }
            else
            {
                txtMatKhau.UseSystemPasswordChar = true; // Ẩn ký tự thật
            }
        }
